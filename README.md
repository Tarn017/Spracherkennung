...
![splits Screenshot](https://github.com/Tarn017/Spracherkennung/blob/main/assets/splitsample.png)

8.	Wähle eine passende Länge (empfohlen 1000ms) und aktiviere shift samples (rechts unten) für eine bessere Generalisierung. Achte darauf, dass die Boxen wirklich über den einzelnen Wörtern liegen. Du kannst die Boxen verschieben, löschen oder weitere hinzufügen:

![box Screenshot](https://github.com/Tarn017/Spracherkennung/blob/main/assets/boxen.png)

10.	(Optional) Der Datensatz kann für eine bessere Generalisierung mit noise-, sowie unknown-daten aus dem Ordner [MP3-Data](https://github.com/Tarn017/Spracherkennung/tree/main/data/MP3_Data) erweitert werden. Klicke dafür zunächst auf Upload Data:

![uploaddata Screenshot](https://github.com/Tarn017/Spracherkennung/blob/main/assets/uploaddata.png)

12.	(Optional) Klicke anschließend auf Select a Folder und wähle den kompletten Ordner MP§_Daten aus. Es können theoretisch auch kleinere Unterordner oder nur einzelne Dateien hochgeladen werden:

![splittt Screenshot](https://github.com/Tarn017/Spracherkennung/blob/main/assets/traintestsplit.png)
...
![folder Screenshot](https://github.com/Tarn017/Spracherkennung/blob/main/assets/selectfolder.png)
